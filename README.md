...
To generate the key use [Taz](https://github.com/goldfinch/taz) with the following command `php taz generate:crypto-key` or run in php instead `bin2hex(random_bytes(16))`
